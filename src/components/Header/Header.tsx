...
export default function Header() {
  ...
  return (
    ...
    // <Container className="p-3" fluid style={{ backgroundColor: '#ffffff', padding: '5px 50px' }}>
    //   <div
    //     className="d-flex flex-column flex-lg-row align-items-center justify-content-between w-
    //   w-100"
    //   >
    //     <Navbar expand="lg" expanded={expanded} className="w-100">
    ...
    //                 <div style={{ cursor: 'pointer' }} onClick={() => setMenuVisible(!menuVisible)}>
    //                   <div
    //                     style={{
    //                       backgroundImage: `url('/path/to/icon.png')`, // Замените на ваш путь к иконке
    //                       width: '40px',
    //                       height: '40px',
